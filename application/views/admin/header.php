        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"> <?php if($this->session->userdata('user_name')) echo $this->session->userdata('user_name'); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php if($this->session->userdata('user_name')) echo $this->session->userdata('user_name'); ?>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url('index.php/welcome/bookingMaster'); ?>">
            <i class="fa fa-th"></i> <span>Complain Booking</span>
          </a>
        </li>
		<li>
          <a href="<?php echo base_url('index.php/welcome/site_view'); ?>">
            <i class="fa fa-th"></i> <span>Site</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('index.php/welcome/supervisor_view'); ?>">
            <i class="fa fa-th"></i> <span>Supervisor</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('index.php/welcome/allocate_supervisor_view'); ?>">
       ...
       <li>
          <a href="<?php echo base_url('index.php/welcome/allocate_technician_view'); ?>">
